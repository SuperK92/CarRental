...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('[name=fecha_recogida]').datepicker({
                    format: "dd/mm/yyyy",
                    startDate: tomorrow
                })
                .on('changeDate', function(ev) {
                    ...
                    fechaHoy.setDate(startDate.getDate() + 0);

                    var manana = startDate;
                    manana.setDate(manana.getDate() + 1);

                    $("[name=fecha_devolucion]").datepicker('setStartDate', startDate);
                    $('[name=fecha_devolucion]').datepicker('update', manana);

                });

            $("[name=fecha_devolucion]").datepicker({
                    format: "dd/mm/yyyy",
                    startDate: tomorrow
                })
                .on("changeDate", function(ev) {
