            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="fecha_nacimiento" class="col-md-4 col-form-label text-md-right">{{ __('fecha_nacimiento') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="permiso_conducir" class="col-md-4 col-form-label text-md-right">{{ __('permiso_conducir') }}</label>

                            <div class="col-md-6">
                                <input id="permiso_conducir" type="text" class="form-control @error('permiso_conducir') is-invalid @enderror" name="permiso_conducir" value="{{ old('permiso_conducir') }}" required autocomplete="permiso_conducir" autofocus>
